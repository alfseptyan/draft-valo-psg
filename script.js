...
const heroes = [
    { name: 'Brimstone', img: 'Assets/HeroPick/Brimstone.webp' },
    { name: 'Omen', img: 'Assets/HeroPick/Omen.webp' },
    { name: 'Raze', img: 'Assets/HeroPick/Raze.webp' },
    { name: 'Jett', img: 'Assets/HeroPick/Jett.webp' },
    { name: 'Sage', img: 'Assets/HeroPick/Sage.webp' },
    { name: 'Viper', img: 'Assets/HeroPick/Viper.webp' },
    { name: 'KAY/O', img: 'Assets/HeroPick/KAYO.webp' },
    { name: 'Skye', img: 'Assets/HeroPick/Skye.webp' },
    { name: 'Breach', img: 'Assets/HeroPick/Breach.webp' },
    { name: 'Cypher', img: 'Assets/HeroPick/Cypher.webp' },
    { name: 'Phoenix', img: 'Assets/HeroPick/Phoenix.webp' },
    { name: 'Sova', img: 'Assets/HeroPick/Sova.webp' },
    { name: 'Yoru', img: 'Assets/HeroPick/Yoru.webp' },
    { name: 'Astra', img: 'Assets/HeroPick/Astra.webp' },
    { name: 'Killjoy', img: 'Assets/HeroPick/Killjoy.webp' },
    { name: 'Chamber', img: 'Assets/HeroPick/Chamber.webp' },
    { name: 'Neon', img: 'Assets/HeroPick/Neon.webp' },
    { name: 'Fade', img: 'Assets/HeroPick/Fade.webp' },
    { name: 'Harbor', img: 'Assets/HeroPick/Harbor.webp' },
    { name: 'Reyna', img: 'Assets/HeroPick/Reyna.webp' },
    { name: 'Gekko', img: 'Assets/HeroPick/Gekko.webp' },
    { name: 'Clove', img: 'Assets/HeroPick/Clove.webp' },
    { name: 'Deadlock', img: 'Assets/HeroPick/Deadlock.webp' },
    { name: 'Vyse', img: 'Assets/HeroPick/Vyse.webp' },
    { name: 'Iso', img: 'Assets/HeroPick/Iso.webp' },
